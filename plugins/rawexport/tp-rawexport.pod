...
sign (C<#>). Also C<^X^> defines a period of X seconds, and this string is
replaced with the number of seconds from today's start of the day in GMT time
zone, rounded to the specified period. For examnple, C<^600^> defines a period
