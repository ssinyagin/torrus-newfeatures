...
from Francois Mikus:
    ...
    --- Francois Mikus <fmikus@acktomic.com> wrote:
...
Version 0.1.8 will be the last of RRFW, unless some urgencies arise. This
release will include:

=over 4

=item * Updated Apache2 support

The newer mod_perl versions are not compatible with current Apache2 handler
in RRFW. This will be fixed soon.

=item * Help files updated

Some help files need to be finished.
