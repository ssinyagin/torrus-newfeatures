...
other entities only if they are previously defined.
 ...
 <report name="example.com-monthly-traffic">
   ...
   <vector name="default-storage">
     <param name="vector-type" value="template"/>
     <param name="storage-names" value="DEFAULT,BACKUP"/>
     <param name="consolidation-func" value="max"/>
     <param name="step" value="300"/>
   </vector>     

   <vector name="upstream-bytes">
     <param name="vector-type" value="storage"/>
     <param name="inherit" value="default-storage"/>
     <param name="service-id" value="EXAMPLECOM01_IN"/>
   </vector>

   <vector name="downstream-bytes">
     <param name="vector-type" value="storage"/>
     <param name="inherit" value="default-storage"/>
     <param name="service-id" value="EXAMPLECOM01_OUT"/>
   </vector>

   <!-- Take the maximum rate from input and output, and present it in
        bit per second -->
   <vector name="max_bps">
     <param name="vector-type" value="expression"/>
     <param name="rpn-expr"/>
       {upstream_bytes},{downstream_bytes},MAX,8,*
     </param>     
   </vector>
