...
in order for Apache2Handler to work.
...
as C<./configure> arguments. See C<./configure --help> for details. Example:

  ./configure pkghome=/opt/torrus
...
By default, Torrus uses the following directory structure:
...
The path F</srv/torrus/collector_rrd> is used as default by C<torrus genddx>
